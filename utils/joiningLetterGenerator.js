...
async function generateJoiningLetter(member) {
  try {
    ...
    if (!execPath) console.warn('⚠️ No Chrome/Chromium executable found; Playwright may fail to launch');
    console.log('Using Playwright executablePath:', execPath || 'bundled');
